...
class Television(HDMIConnector, RCAConnector, PowerOutlet):
...
class GameConsole(HDMIConnector, EthernetConnectior, PowerOutlet):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(EthernetConnectior, PowerOutlet):
    def connect_to_tv(self, television):
